#!/bin/bash
# Setup script for aws_infoblox_vpc_manager_working.py
# This script creates a virtual environment and installs dependencies

set -e  # Exit on error

echo "=========================================="
echo "AWS InfoBlox VPC Manager Working Setup"
echo "=========================================="
echo ""
...
pip install -r requirements_aws_working.txt
...
echo "     python aws_infoblox_vpc_manager_working.py --help"
echo ""
echo "  3. Example usage:"
echo "     python aws_infoblox_vpc_manager_working.py --dry-run"
echo ""
