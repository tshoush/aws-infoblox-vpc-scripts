...
echo "=========================================="
echo "AWS InfoBlox VPC Manager Complete Setup"
echo "=========================================="
echo ""
...
pip install -r requirements_aws_complete.txt
...
echo "     python aws_infoblox_vpc_manager_complete.py --dry-run"
echo ""
echo "  4. Example usage (interactive mode):"
echo "     python aws_infoblox_vpc_manager_complete.py -i --create-missing"
echo ""
