#!/bin/bash
# Setup script for prop_infoblox_import.py
# This script creates a virtual environment and installs dependencies

set -e  # Exit on error

echo "=========================================="
echo "PropInfoBlox Import Setup"
echo "=========================================="
echo ""
...
pip install -r requirements_prop.txt
...
echo "     python prop_infoblox_import.py --help"
echo ""
echo "  3. Example usage:"
echo "     python prop_infoblox_import.py --dry-run"
echo ""
